...
class QASeeder extends Seeder
{
    public function run(): void
    {
        $qas = [
            ...
            [
                'question' => 'How are AI governance tools governed for organizational usage?',
                'answer' => 'Organizations govern AI tools through structured frameworks that include: vendor assessment and approval processes, usage policies defining acceptable use cases, access controls and permission management, monitoring and audit trails for tool usage, data handling and privacy protocols, integration with existing IT governance, regular compliance reviews, and incident response procedures. Tools are typically categorized by risk level, with high-risk tools requiring stricter oversight. Organizations also maintain tool inventories, conduct periodic reviews of tool effectiveness, and ensure alignment with regulatory requirements like GDPR, HIPAA, or industry-specific standards.',
                'is_published' => true,
                'is_featured' => true,
