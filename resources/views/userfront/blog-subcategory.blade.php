...
<div class="bg-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center">
            ...
            <h1 class="font-playfair text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">
...
<div class="bg-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between mb-8">
            <h2 class="font-playfair text-2xl font-bold text-gray-900">Related Articles from {{ $parent->name }}</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <a href="{{ route('blog.show', $relatedBlog->slug) }}" class="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow overflow-hidden border border-gray-100 block">
                <div class="relative">
                ...
                <div class="p-6">
                    ...
                    <h3 class="font-futura text-sm font-bold text-gray-900 mb-4 line-clamp-2">{{ $relatedBlog->title }}</h3>
                    <span class="inline-flex items-center gap-2 text-blue-600 font-medium hover:text-blue-700 transition-colors">
                        <span>Read More</span>
                        <svg width="14" height="14" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M3.959 9.5h11.083m0 0L9.501 3.958M15.042 9.5l-5.541 5.54" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
