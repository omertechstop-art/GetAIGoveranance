...
<nav class="flex items-center justify-between p-4 md:px-16 lg:px-24 xl:px-32 md:py-6 w-full">
    ...
    <div class="{{ $mobileMenuOpen ? 'max-md:w-full' : 'max-md:w-0' }} max-md:absolute max-md:top-0 max-md:left-0 max-md:transition-all max-md:duration-300 max-md:overflow-hidden max-md:h-full max-md:bg-white/95 max-md:backdrop-blur max-md:flex-col max-md:justify-center flex items-center gap-8 font-medium">
        ...
        <button wire:click="toggleMobileMenu" class="md:hidden bg-gray-800 hover:bg-black text-white p-2 rounded-md aspect-square font-medium transition">
    ...
    <div class="hidden md:flex items-center gap-3">
        <button class="border border-gray-300 hover:border-gray-400 text-gray-700 px-4 py-2 rounded-full text-sm font-medium transition">
            Request Guidance
        </button>
        <button class="bg-gray-800 hover:bg-black text-white px-4 py-2 rounded-full text-sm font-medium transition">
            Add Your Tool
        </button>
    </div>
