...
<footer class="relative overflow-hidden w-full text-sm text-slate-500 bg-gray-50 pt-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
        <div class="sm:col-span-2 lg:col-span-1">
            <div class="mb-4">
                <img src="{{ asset('logo-check-check.png') }}" alt="GetAIGovernance" class="h-10 w-auto">
            </div>
            <p class="text-sm/7 mt-6">
                The leading marketplace for AI governance, compliance, and monitoring solutions. Find the right tools to govern, monitor, and comply with AI regulations.
            </p>
        </div>
        <div class="flex flex-col lg:items-center lg:justify-center">
            <div class="flex flex-col text-sm space-y-2.5">
                ...
                <a class="hover:text-slate-600 transition font-semibold" href="#">About us</a>
                <a class="hover:text-slate-600 transition font-semibold" href="#">Contact us</a>
                <a class="hover:text-slate-600 transition font-semibold" href="#">Privacy policy</a>
                <a class="hover:text-slate-600 transition font-semibold" href="#">Terms of Service</a>
            </div>
        </div>
        <div>
            <h2 class="font-semibold text-gray-800 mb-5">Subscribe to our newsletter</h2>
            <div class="text-sm space-y-6 max-w-sm">
                <p>The latest AI governance insights, articles, and resources, sent to your inbox weekly.</p>
                <div class="flex items-center">
                    <input class="rounded-l-md bg-gray-100 outline-none w-full max-w-64 h-11 px-3" type="email" placeholder="Enter your email">
                    <button class="bg-blue-600 hover:bg-blue-700 cursor-pointer transition px-4 h-11 text-white rounded-r-md">
                        Subscribe
                    </button>
                </div>
            </div>
